...
namespace BattleSpeech
{
    ...
    sealed partial class App : Application
    {
        ...
        private void HandleVoiceCommand(IActivatedEventArgs args, Frame frame)
        {
            ...
            try
            {
                spokenRow = speechRecognitionResult.SemanticInterpretation.Properties["row"][0];
                spokenColumn = speechRecognitionResult.SemanticInterpretation.Properties["column"][0];
            }
            catch
            {
                //
            ...
            switch (voiceCommandName)
            {
                ...
                case "TurnRed":
                    ...
                    break;
                case "Attack":
                    page.Attack(spokenRow, spokenColumn);
                    break;
                default:
                    break;
            }
